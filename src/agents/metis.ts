...
task(subagent_type="explore", load_skills=["librarian"], prompt="I'm implementing [technology] and need to understand best practices before making recommendations. Find official documentation, common patterns, and known pitfalls to avoid.")
\`\`\`
...
task(subagent_type="explore", load_skills=["librarian"], prompt="I'm implementing Y and need authoritative guidance. Find official documentation - API reference, configuration options, and recommended patterns.")
task(subagent_type="explore", load_skills=["librarian"], prompt="I'm looking for proven implementations of Z. Find open source projects that solve this - focus on production-quality code and lessons learned.")
\`\`\`
...
[Results from explore or librarian skill-backed research if launched]
